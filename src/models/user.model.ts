...
// It says: "Any object that claims to be a User MUST have these fields."
// The "?" after a field name means it is OPTIONAL.
// ---------------------------------------------------------------
export interface User {
  id: number; // Auto-generated unique identifier (1, 2, 3, …)
  name: string; // Full name, e.g. "Alice Johnson"
  email: string; // Email address, e.g. "alice@example.com"
  username: string; // Short handle, e.g. "alice_j"
  phone: string; // Phone number, e.g. "+1-555-0101"
  role: 'host' | 'guest'; // A user is either a host (rents out) or a guest (books)
  avatar?: string; // Optional profile picture URL
  bio?: string; // Optional short description about the user
}
